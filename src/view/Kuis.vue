...
<template>
  <div v-if="materi" class="bg-gray-900 text-gray-300 font-sans leading-normal tracking-normal">
    <main class="container mx-auto px-6">
      <div class="bg-gray-800 p-8 rounded-lg shadow-lg">
        ...
        <!-- Padlet -->
        <div v-if="materi.kuis" class="w-full h-auto overflow-hidden rounded-lg shadow-md">
          <iframe :src="materi.kuis" frameborder="0" allow="camera;microphone;geolocation;display-capture;clipboard-write" style="width: 100%; height: 608px; display: block; padding: 0; margin: 0"></iframe>
        </div>
